...
;(function(window) {
    ...
    TabsNav.prototype._init = function() {
        this.DOM.tabs = [].slice.call(this.DOM.el.querySelectorAll('.tabs_nav--item'));
        this.DOM.bars = [].slice.call(this.DOM.el.querySelectorAll('.tabs_nav--bar'));
    ...
    TabsNav.prototype._initEvents = function() {
        ...
        enquire.register('screen and (min-width:0) and (max-width:40em)', {
            match: function() {
                ...
                if(!self.isOpen && !self.isVisible) {
                    self.DOM.el.classList.add('tabs_nav--hidden');
                }
            }
        });
        enquire.register('screen and (min-width:40em)', {
            match: function() {
                // show
                if( !self.DOM.el.classList.contains('tabs_nav--hidden-default') ) {
                    self.DOM.el.classList.remove('tabs_nav--hidden');
                }
            }
        });
    };
    ...
    TabsNav.prototype.show = function(callback) {
        ...
        this.DOM.tabs.forEach(function(tab) {
            var bar = tab.querySelector('.tabs_nav--bar'),
                title = tab.querySelector('.tabs_nav--title');
        ...
        this.DOM.el.classList.remove('tabs_nav--hidden');
        ...
        // Animate titles.
        var titles = this.DOM.el.querySelectorAll('.tabs_nav--vertical > .title');
        anime.remove(titles);
        var animeTitles = {
            targets: titles,
            duration: 500,
    ...
    TabsNav.prototype.hide = function(callback) {
        ...
        // Animate titles.
        var titles = this.DOM.el.querySelectorAll('.tabs_nav--title');
        anime.remove(titles);
        var animeTitles = {
            targets: titles,
            duration: 100,
