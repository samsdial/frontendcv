...
(function() {
    var tnav = new TabsNav(document.querySelector('nav.tabs_nav'), {
            movable: 'all',
            layout: 'vertical',
            animeduration: 1000,
        ...
        contentItems = [].slice.call(document.querySelectorAll('.tabscontent > .tabscontent--item')),
        backCtrl = document.querySelector('.tabscontent > button.btn--site'),
    ...
    function openTabCallback(anim, idx, tab) {
        if( anim.progress > 10 && !isContentShown ) {
            ...
            contentItem.classList.add('tabscontent_item--current');
    ...
    function closeTabs() {
        ...
        anime({
            ...
            complete: function() {
                ...
                contentItem.classList.remove('tabscontent_item--current');
            }
        });
